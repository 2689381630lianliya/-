...
<header class="mui-header">
    ...
    <div class="top-right">
        ...
        <a href="../views/writearticlePage.jsp">开始创作</a>
        <a href="/Controller/Logout">退出登录</a>
    </div>
</header>
${applicationScope.get("Logincount")}登录人数
<div class="mui-center">
    <div class="resou"><label >今日热搜</label></div>
    <table  class="mui-table">
       <c:forEach items="${link}" var="list">

           <tr >
               <td class="td_lable" width="500" >
                   <a href="/Controller/Showqs?title=${list.title}&name=${list.name}">
                           ${list.title}</a></td>
               <td>　　　　　</td>
               <td>${list.name}</td>
