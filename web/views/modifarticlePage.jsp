...
<div class="mui-center">
    <form  class="write" action="/Controller/modifarticle">
        <div class="text">
            <input type="text" name="title" style="font-size: 18px" value="${title}" placeholder="请输入标题" />
            <div class="write-content">

                <textarea  name="content" style="font-size: 18px" cols="140" rows="40">
                    ${content}
                </textarea></div>
        </div>
