...
<header class="mui-header">
    ...
    <div class="top-right">
        ...
        <a href="/Controller/center">修改密码</a>
...
<div class="mui-mid">
    ...
    <div style="line-height: 60px" class="right-box">
       <form action="/Controller/modifpass" method="post">
           <label>旧　　密　　码:<input class="text" type="text" name="oldpass" /></label><br />
           <label>新　　密　　码:<input class="text" type="password" name="newpass" /></label><br />
           <label>确　认　密　码:<input class="text" type="password" name="ensurepass" /></label><br />
           <div style="line-height: 40px" id="modif"><input class="submit" type="submit" value="提　　　交" /></div>
       </form>
    </div>
