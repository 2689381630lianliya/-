...
<div class="mui-mid">
    ...
    <div class="right-box">
        ...
        <div class="linkpage">
            <a href="/Controller/recordpage/0">首页</a>
            <a href="/Controller/recordpage/${currentpage}-1">上一页</a>
            <label>-${currentpage}-</label>
            <a href="/Controller/recordpage/${currentpage}+1">下一页</a>
            <a href="/Controller/recordpage/${pagecount}">末页</a>
